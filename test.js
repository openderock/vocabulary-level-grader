...
test('grade the sample text', t => {
    ...
    t.is(output.meta.levels.A1, 45.205479452054796);
    t.is(output.meta.levels.A2, 52.054794520547944);
    t.is(output.meta.levels.B1, 60.273972602739725);
    t.is(output.meta.levels.B2, 73.97260273972603);
    t.is(output.meta.levels.C1, 84.93150684931507);
    t.is(output.meta.levels.C2, 94.52054794520548);
});